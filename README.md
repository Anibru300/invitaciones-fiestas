...
Repositorio con plantillas de invitaciones digitales para cumpleaños y fiestas.

Cada invitación es independiente y puede personalizarse con los datos del evento.
...
│       └── datos.md      # Datos del evento (ficticios hasta confirmar)
└── README.md
```
...
Uso personal. Las plantillas son para uso propio y de amigos/familia.
